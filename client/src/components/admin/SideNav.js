      ...
      <div>
        ...
        <div className="sideNav_contents">
          <ul className={menuStatus ? "open" : "close"}>
            ...
            <li>
              <NavLink to="/admin/slider" onClick={() => setMenuStatus(false)}>
            ...
            <li className="subNav_wrapper">
              <span
                className="subNav d-flex justify-content-between"
            ...
            <li>
              <NavLink to="/admin/recipes" onClick={() => setMenuStatus(false)}>
                <img src={recipes} alt="recipes icon" />
                Recipes
              </NavLink>
            </li>
            <li>
              <NavLink to="/admin/blog" onClick={() => setMenuStatus(false)}>
            ...
            <li>
              <NavLink to="/admin/pages" onClick={() => setMenuStatus(false)}>

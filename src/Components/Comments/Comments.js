                                    ...
                                    return (
                                        <div className='p-3 col-md-4 col-12'>
                                            <div className=''>
                                                ...
                                                <div style={{ backgroundColor: '#FEF3F1' }} className='p-3'>
                                                    <h4>Tittle</h4>
                                                    <p className='mt-2 pb-0'>Lorem ipsum dolor sit amet consectetur adipisicing elit.Magnam explicabo sed harum eveniet </p>
                                                    <div style={{ color: '#FF4B4A' }} className='d-flex justify-content-between'>
                                                        <div className='d-flex'>
                                                            <h5 className='me-3'><i class="fas fa-heart"></i>600</h5>

  ...
  return (
    <div className="relative md:flex min-h-screen">
      ...
      <div className=" md:hidden flex  bg-red-500  text-red-100 justify-between px-5 py-7">
        <a className="text-2xl font-bold no-underline text-red-100" href="#">
          RecipeMania
        </a>
...
<<<<<<< HEAD
      {/* side bar is here  */}
      <div
        className="w-64 bg-red-500 text-neutral-100	 space-y-5 absolute inset-y-0 left-0 transform -translate-x-full transition duration-200 md:relative md:-translate-x-0  "
        idName="slide"
      >
        {/* logo  */}
        <div>
          <a
            href="#"
            className="text-2xl font-bold mt-5 flex items-center justify-center no-underline"
            style={{ color: "white" }}
          >
        ...
        <nav className="text" style={{ color: "white" }}>
          <NavLink
            ...
            href=""
            style={{ color: "white" }}
            className="block py-3 px-5 hover:bg-red-700 transition no-underline duration-200"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
    ...
    return (
        <div className='relative md:flex min-h-screen'>
            ...
            <nav className='text' style={{color:'white'}} >
                ...
                <Link to={`${url}/newsLetter`} href="" style={{color:'white'}} className="block py-3 px-5 hover:bg-red-700 transition no-underline duration-200"><svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 inline" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 19v-8.93a2 2 0 01.89-1.664l7-4.666a2 2 0 012.22 0l7 4.666A2 2 0 0121 10.07V19M3 19a2 2 0 002 2h14a2 2 0 002-2M3 19l6.75-4.5M21 19l-6.75-4.5M3 10l6.75 4.5M21 10l-6.75 4.5m0 0l-1.14.76a2 2 0 01-2.22 0l-1.14-.76" />
                </svg>NewsLetters</Link>

                <Link to={`${url}/manageAboutUs`} href="" style={{color:'white'}} className="block py-3 px-5 hover:bg-red-700 transition no-underline duration-200"><svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 inline" fill="none" viewBox="0 0 24 24" stroke="currentColor">
...
<<<<<<< HEAD
        <div class="flex-grow  text-5xl font-bold">

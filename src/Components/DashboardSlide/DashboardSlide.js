    ...
    return (
        <div className='relative md:flex min-h-screen'>
            ...
            <nav className='text' style={{color:'white'}} >
                ...
                <button style={{color:'white'}} className="block py-3 px-5 hover:bg-red-700 transition no-underline duration-200"><svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 inline" fill="none" viewBox="0 0 24 24" stroke="currentColor">

...
const { getUsersByAdmin, getAdminProfile, getUserBySlugByAdmin, registerAdmin, registerUserByAdmin, deleteUserByAdmin, fetchAdmins, updateAdmin } = require("../controllers/adminController")

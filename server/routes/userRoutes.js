...
const { profileUpdate, searchUser, deleteUser, getMyProfile, fetchSubscribers, canUpdateUser, canDeleteUser, getUserBySlug } = require("../controllers/userController")
...
router.put("/profile", requireSignIn, authMiddleware, canUpdateUser, profileUpdate)
